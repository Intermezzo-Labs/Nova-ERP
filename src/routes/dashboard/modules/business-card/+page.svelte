<script lang="ts">
	...
	import type { NovaUserProfile } from '$lib/types/user';
...
<div class="container mx-auto p-4 sm:p-6">
	<div class="mb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between">
		...
		<h1 class="mb-4 text-2xl font-bold sm:mb-0">Business Card Generator</h1>
		<Button
			on:click={downloadBusinessCard}
			disabled={!browser}
			class="w-full rounded-lg bg-gradient-to-r from-blue-600 to-blue-700 px-4 py-2 font-medium text-white shadow-lg transition-all duration-200 hover:from-blue-700 hover:to-blue-800 hover:shadow-xl sm:w-auto"
		>
	...
	<!-- Edit Form -->
	<div class="mx-auto mt-4 w-full max-w-xl space-y-4 sm:mt-6 sm:space-y-6">
