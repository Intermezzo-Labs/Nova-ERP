            ...
            >
                ...
                >
                    ...
                    {#if item.badge !== undefined}
                        <span
                            class="ml-auto rounded-full bg-primary-100 px-2.5 py-0.5 text-xs font-medium text-primary-600 dark:bg-primary-900/30 dark:text-primary-400"
                        >
                            {item.badge}
                        </span>
                    {/if}
